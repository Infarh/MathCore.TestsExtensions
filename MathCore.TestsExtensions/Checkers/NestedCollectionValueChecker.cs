...
public sealed class NestedCollectionValueChecker<TValue, TBaseValue> : CollectionChecker<TValue>
{
    ...
    internal NestedCollectionValueChecker(ICollection<TValue> ActualCollection, ValueChecker<TBaseValue> BaseChecker) : base(ActualCollection) => _BaseChecker = BaseChecker;
